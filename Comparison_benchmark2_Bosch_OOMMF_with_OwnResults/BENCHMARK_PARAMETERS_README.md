...
The current OOMMF reference implementation:
- ✅ **Correctly** uses My/Ms for hard-axis electrical sensitivity
- ✅ **Correctly** implements G(H) = G₀(1 + P²·My/Ms)
- ✅ **Matches** MaMMoS D6.2 page 8 specification
- For case (c): Since H is along +y and reference is along +y, using M_over_Ms (field projection) equals My/Ms (reference projection)
